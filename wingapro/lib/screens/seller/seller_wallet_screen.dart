...
class _SellerWalletScreenState extends State<SellerWalletScreen> with SingleTickerProviderStateMixin {
                ...
                Card(
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        const Text('Deposit Money', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text('Available for withdrawal', style: TextStyle(color: Colors.white60, fontSize: 12)),
            ],
          ),
        ),
      ),
